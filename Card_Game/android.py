...
frames = [PATH + "bg_imgs/frame_000.png",PATH + "bg_imgs/frame_001.png",PATH + "bg_imgs/frame_002.png",PATH + "bg_imgs/frame_003.png",PATH + "bg_imgs/frame_004.png",PATH + "bg_imgs/frame_005.png",PATH + "bg_imgs/frame_006.png",PATH + "bg_imgs/frame_007.png",PATH + "bg_imgs/frame_008.png",PATH + "bg_imgs/frame_009.png"]
...
# Set up the mixer
pygame.mixer.init()
pygame.mixer.music.load(PATH + "music/SKYLINE.mp3")
pygame.mixer.music.set_volume(0.04)  # You can adjust the volume from 0.0 to 1.0
...
card_images = [PATH + "card_imgs/CuteCard1.jpg",PATH +  "card_imgs/CuteCard2.jpg",PATH +  "card_imgs/CuteCard3.jpg",PATH +  "card_imgs/CuteCard4.jpg",PATH +  "card_imgs/CuteCard5.jpg",PATH + "card_imgs/CuteCard6.jpg",PATH + "card_imgs/CuteCard7.jpg",PATH + "card_imgs/CuteCard8.jpg"]
...
for i in range(4):
    ...
    cardA = Card(PATH + "card_imgs/card_back.png", card_images[rand_img],points_dict[A_Key][0], points_dict[A_Key][1])
    ...
    cardB = Card(PATH + "card_imgs/card_back.png", card_images[rand_img],points_dict[B_Key][0], points_dict[B_Key][1])
...
badcard = Card(PATH + "card_imgs/card_back.png",PATH + "card_imgs/BadCard1.jpg",points_dict[available_loc_keys[0]][0],points_dict[available_loc_keys[0]][1])
...
while running:
    ...
    #TIMER CHECK
    time_left = set_time - int(pygame.time.get_ticks() // 1000)
    if time_left <= 0:
        time_left = 0
    ...
    if time_left == 0:
        ...
        cards_in_play = []
        #print("GAME OVER")
        lose_msg = pygame.image.load(PATH + "msgs/LoseMessage.png").convert_alpha()
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.FINGERDOWN:
                ...
                if lose_rect.collidepoint((touchX,touchY)):
                    ...
                    set_time = 30 + int(pygame.time.get_ticks() // 1000)
    ...
    #NO CARDS LEFT TO CHECK
        ...
        screen.fill((0,0,0))
        set_time = 10 + int(pygame.time.get_ticks() // 1000)
        if badcard in cards_in_play:
            cards_in_play.remove(badcard)
        cards_in_play = []
        #print("YOU WIN")
        win_msg = pygame.image.load(PATH + "msgs/WinMessage.png").convert_alpha()
